...
class Settings(BaseSettings):
    ...
    docker_container_name: str = "opsguard-demo-service"
    docker_demo_service_url: str = "http://opsguard-demo-service:8081"
    docker_network_name: str = "opsguard-network"
    docker_network_alias: str = "demo-service"
    docker_demo_image: str = "opsguard-demo:local"
    docker_demo_internal_port: int = 8081
    docker_demo_host_port: int = 8081
    docker_managed_label_key: str = "com.opsguard.managed"
